        ...
        <LayoutClientWrapper
          footer={
            <footer className="bg-[#061C0F] border-t border-white/10 py-10 md:py-16 text-sm text-slate-300 relative z-10 w-full overflow-hidden">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:grid md:grid-cols-12 gap-8 text-center md:text-left items-center md:items-start">
                {/* Column 1: Logo & Description */}
                <div className="space-y-4 col-span-1 sm:col-span-2 md:col-span-4 flex flex-col items-center md:items-start">
                  <Link href="/" className="font-display font-bold text-2xl text-white flex flex-col gap-2 items-center md:items-start">
                    <img src="/logo.png" alt="EcoFone Logo" className="h-12 sm:h-16 md:h-20 w-auto object-contain bg-transparent p-0" />
                  ...
                  <div className="pt-2 border-t border-white/5 mt-4 w-full flex justify-center md:justify-start">
                    <WriteReviewButton />
                  </div>
                </div>
