  ...
  return (
    <html lang="en" className={`${inter.variable} ${plusJakarta.variable}`} data-scroll-behavior="smooth">
      ...
      <body className="bg-dots min-h-screen flex flex-col font-sans relative">
        <LayoutClientWrapper
          footer={
            <footer className="bg-[#061C0F] border-t border-white/10 pt-6 pb-16 md:py-16 text-sm text-slate-300 relative z-10 w-full overflow-hidden">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:grid md:grid-cols-12 gap-4 md:gap-8 text-center md:text-left items-center md:items-start">
                ...
                <div className="space-y-3 col-span-1 sm:col-span-2 md:col-span-4 flex flex-col items-center md:items-start">
                  ...
                  <p className="text-[11px] md:text-xs leading-relaxed text-slate-450">
                  ...
                  <div className="pt-2 border-t border-white/5 mt-2 w-full flex justify-center md:justify-start">
                    <WriteReviewButton />
                  </div>
                </div>

                {/* Column 2: Quick Links */}
                <div className="col-span-1 md:col-span-2 md:pl-4 w-full flex flex-col items-center md:items-start">
                  <h4 className="text-white font-semibold mb-2 text-xs md:text-sm uppercase tracking-wider">Quick Links</h4>
                  <ul className="space-y-2 text-[11px] md:text-xs text-slate-400">
                ...
                <div className="col-span-1 md:col-span-3 w-full flex flex-col items-center md:items-start">
                  <h4 className="text-white font-semibold mb-2 text-xs md:text-sm uppercase tracking-wider">Contact & Support</h4>
                  <ul className="space-y-2 text-[11px] md:text-xs text-slate-400">
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 pt-6 border-t border-white/5 text-center text-[10px] md:text-xs text-slate-500">
